...
document.getElementById('loadingButton').addEventListener('click', function() {
  ...
  // Opcional: Desactivar el botón para que el usuario no pueda volver a pulsarlo mientras se carga.
  this.disabled = true;
   ...
   // Su proceso de carga aquí
  // Una vez finalizada la carga, puedes ocultar el spinner y volver a activar el botón
  // spinner.classList.add('d-none');
  // this.disabled = false;
});

//Obtener la referencia del form
